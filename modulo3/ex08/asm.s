.section .text
	...
	test_even:
		...
		idivl %ecx # divides the first parameter with value 2
	...
	my_loop:
		...
		pushq %rcx # decrements the rcx register -> increase the length of stack
		call test_even # calls the test_even function
		popq %rcx # increments the rcx register -> decrease the length of stack
